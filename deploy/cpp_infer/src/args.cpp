...
// detection related
DEFINE_string(det_model_dir, "./infer/ch_PP-OCRv4_det_infer", "Path of det inference model.");
...
// recognition related
DEFINE_string(rec_model_dir, "./infer/ch_PP-OCRv4_rec_infer", "Path of rec inference model.");
DEFINE_int32(rec_batch_num, 6, "rec_batch_num.");
DEFINE_string(rec_char_dict_path, "./infer/ppocr_keys_v1.txt",
              "Path of dictionary.");
